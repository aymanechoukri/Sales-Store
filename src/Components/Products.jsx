          ...
          <div className="max-w-2xl mx-auto h-full flex flex-col">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                ...
                <button className="w-full sm:w-auto px-10 py-4 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-lg cursor-pointer flex gap-2 items-center active:scale-95">
                  Add to Cart
